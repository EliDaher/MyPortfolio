  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "fixed top-4 inset-x-0 mx-auto z-[5000] flex max-w-fit items-center justify-center space-x-4 rounded-full border border-transparent bg-white px-8 py-2 pr- shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] dark:border-white/[0.15] dark:bg-neutral-900",
          className,
        )}
      >
